window.onload = function() {
	...
	//COMENTARIO C1
	if (localStorage.getItem("monstruosCapturados") != null) {

		var monstruosCapturadosCadena = localStorage.getItem("monstruosCapturados");
		monstruosCapturados = parseInt(monstruosCapturadosCadena);
	} else {
		//ponemos a cero los monstruos capturados en local storage
		localStorage.setItem("monstruosCapturados", monstruosCapturados);
	}
	...
	var dibujaJuego = function() {
		...
		//COMENTARIO C2
		var mensaje = "Monstruos capturados: " + localStorage.getItem("monstruosCapturados");
	...
	//---- COMENTARIO C4
	var boton = document.querySelector("#limpiar-contador");
	boton.addEventListener("click", function() {

		//borra todo		
		monstruosCapturados = 0;
		localStorage.setItem("monstruosCapturados", monstruosCapturados);
	});
